    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            try:
                ...
                newuser = User(email=form.email.data,username=form.username.data,userhash=str(random.getrandbits(128)),password=password_hashed,avatar="/static/img_avatar" +str(random.randint(1,5))+ ".png")
